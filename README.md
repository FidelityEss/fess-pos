...
| `tools/` | `scenarios/` (scenario seeder, QA smoke test), `postman/` (collection for the module API, QA test users), `ops/` (pgTAP on QA, QA-link check, remote purge), `seed/` (definition seed builder), `vendor-engine.mjs` |
