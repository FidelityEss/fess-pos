...
| `packages/fess_pos_engine/` | Pure-Dart engine: JCS hashing, the rules evaluator, and the form resolver, validator and test-case runner for every component (T3-01). Runs the same fixtures as the TS engine, none skipped |
