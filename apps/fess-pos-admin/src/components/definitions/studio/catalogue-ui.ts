...
const COMPONENT_WORDING: Record<string, Wording> = {
  ...
  single_select: { name: 'Choose one', description: 'The agent chooses one answer from a list.', icon: List },
  multi_select: { name: 'Choose several', description: 'The agent ticks every answer that applies.', icon: ListChecks },
